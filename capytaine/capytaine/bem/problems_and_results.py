...
from capytaine.bem.cylindrical_waves import cylindrical_waves_velocity, froude_krylov_force_cyl, WNumber_E
...
class LinearPotentialFlowProblem:
    ...
    def __init__(self, *,
                 ...
                 modeM=_default_parameters['modeM'],
                 modeL=_default_parameters['modeL'], BC="planar",):
        ...
        if ((float(frequency_data[provided_freq_type]) == 0.0 and provided_freq_type in {'omega', 'freq', 'wavenumber'})
            ...
            if provided_freq_type in {'omega', 'freq', 'period'}:
                ...
                if self.water_depth == np.inf:
                    ...
                    # else :
                    #     wavenumber = WNumber_E(period, self.water_depth, self.modeL) 
...
class DiffractionProblem(LinearPotentialFlowProblem):
    ...
    def __init__(self, *,
                 ...
                 g=_default_parameters['g'],
                 wave_direction=_default_parameters['wave_direction'],
                 BC="planar", modeM=_default_parameters['modeM'],
                 modeL=_default_parameters['modeL']):
        ...
        super().__init__(body=body, free_surface=free_surface, water_depth=water_depth, sea_bottom=sea_bottom,
                         ...
                         forward_speed=forward_speed, rho=rho, g=g, modeM=modeM, modeL=modeL, BC=BC)
...
class DiffractionResult(LinearPotentialFlowResult):
    ...
    def records(self):
        ...
        if self.BC=='planar':
            ...
            FK = froude_krylov_force_cyl(self.problem)
        return [dict(**params,
                     influenced_dof=dof,
