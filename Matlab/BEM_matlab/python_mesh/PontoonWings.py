...
# num="3"
# deltaX=3.0
def create_PontoonWings(Dimensions, DimsWings, deltaX, name):
    print("Creating PontoonWings Mesh")
    Bu, L, Dd = Dimensions
    print("Dimentions : ", Bu, "x", L, "x", Dd)
    Br, Dt = DimsWings
    Bd=Bu+2*Br
    print("Dimentions Wings : ", Br, "x", Dt)
    # =======================
    # Initialisation Gmsh
    # =======================
